...
parser.add_argument("--dataset_name", type=str,
                    default="Augmented_data", help="name of the dataset")
...
discriminator = Discriminator(input_shape=(
    opt.channels, *(hr_shape))).to(device)
...
if opt.epoch != 0:
    ...
    generator.load_state_dict(torch.load(
        "saved_models/saved_models/generator_18.pth"))
    discriminator.load_state_dict(torch.load(
        "saved_models/saved_models/discriminator_18.pth"))
